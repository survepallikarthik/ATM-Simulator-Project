...
public class Withdrawl  extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if( ae.getSource()==withdrawl )
        {
            ...
            if(number.equals(""))
            {
                JOptionPane.showMessageDialog(null, "please enter the amount you want to withdrawl");// if he not enter the amount the message should come as box .does he not enterd the amount
